...
Put a # sign then type the comment after it. Example: #comment
...
b**a                = 25 = 25
b%a                 = 1 = 1
a+B                 = Error = NameError: name 'B' is not defined
type(42)            = int =  <class 'int'>
type(42.0)          = float = <class 'float'>
type("C3PO")        = string = <class 'str'>
type(True)          = bool = <class 'bool'>
