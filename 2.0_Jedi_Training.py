...
b**a                25          =25
b%a                 1           =1
a+B                 Error       =Error, "B" not identified
type(42)            class int   =class 'int'
type(42.0)          class float =class 'float'
type("C3PO")        class str   =class 'str'
type(True)          class bool  =class 'bool'
...
a-=7
a             15            =15.0
type(a)       class 'int'   =class 'float'


4.) What is the mistake in the following code. Fix it!

x,y = (4,5)
a = 3(x + y)    # Put a * between 3 and (x + y)
a               # a is 27
...
x,y,z =(3,4,5)
ave = x+y+z/3   # Put () around x+y+z; PEMDAS
ave             # ave is 4.0
