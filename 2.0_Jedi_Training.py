...
a = 3(x + y)
a
the mistake is that there is no coma between the x and the y
...
ave = x+y+z/3
ave
so what i did was put ave=x+y+z and then did ave/3 and that gave me the average which is 4
